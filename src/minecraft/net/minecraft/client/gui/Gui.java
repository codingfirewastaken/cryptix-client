...
public class Gui
{
    ...
    public static void drawRect(double x, double d, double e, double g, int color)
    {
        if (x < e)
        {
            double i = x;
        ...
        worldrenderer.pos((double)x, (double)g, 0.0D).endVertex();
        worldrenderer.pos((double)e, (double)g, 0.0D).endVertex();
        worldrenderer.pos((double)e, (double)d, 0.0D).endVertex();
        worldrenderer.pos((double)x, (double)d, 0.0D).endVertex();
        tessellator.draw();
