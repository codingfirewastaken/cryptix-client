...
public class InvManager extends Module{
    ...
    private boolean isTrash(ItemStack stack) {
    	return stack.getUnlocalizedName().contains("arrow") || stack.getUnlocalizedName().contains("tnt") || stack.getUnlocalizedName().contains("bow") || stack.getUnlocalizedName().contains("cobblestone") || stack.getUnlocalizedName().contains("spawn") || stack.getUnlocalizedName().contains("cobweb") || stack.getUnlocalizedName().contains("piston") || stack.getUnlocalizedName().contains("redstone") || stack.getUnlocalizedName().contains("egg") || stack.getUnlocalizedName().contains("flint") || stack.getUnlocalizedName().contains("snow") || stack.getUnlocalizedName().contains("axe") || stack.getUnlocalizedName().contains("pickaxe") || stack.getUnlocalizedName().contains("shovel") || stack.getUnlocalizedName().contains("fish") || stack.getUnlocalizedName().contains("string") || stack.getUnlocalizedName().contains("stick") || stack.getUnlocalizedName().contains("bucket") || stack.getItem() instanceof ItemExpBottle || stack.getItem() instanceof ItemAxe;
    }
