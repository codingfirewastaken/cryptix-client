...
public class ClickGUI extends Module{
	...
	public ClickGUI() {
		...
		Client.instance.settingsManager.addSetting(new Setting("Sound", this, true));
        ...
        Client.instance.settingsManager.addSetting(new Setting("Color1 Alpha", this, 255, 0, 255, true));
        ...
        Client.instance.settingsManager.addSetting(new Setting("Color2 Alpha", this, 255, 0, 255, true));
	}
