...
public class ClickGUI extends Module{
	...
	public ClickGUI() {
        ...
        Client.instance.settingsManager.rSetting(new Setting("Color1 Alpha", this, 255, 0, 255, true));
        ...
        Client.instance.settingsManager.rSetting(new Setting("Color2 Alpha", this, 255, 0, 255, true));
	}
