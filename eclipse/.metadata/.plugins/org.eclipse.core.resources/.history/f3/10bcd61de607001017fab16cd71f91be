...
public class ItemRenderer
{
    ...
    private int equippedItemSlot = -1, rotate;
                    ...
                    switch (enumaction)
                    {
                        ...
                        case BLOCK:
                        	if(anim != null && anim.isToggled()) {
                        		...
                        		if(mode.getString().equalsIgnoreCase("Exhibition")) {
                        		...
                        		if(mode.getString().equalsIgnoreCase("Spin")) {
                        			this.transformFirstPersonItem(f, 0.0F);
                        			this.doBlockTransformations();
                        		...
                        		if(mode.getString().equalsIgnoreCase("None")) {
                        			this.transformFirstPersonItem(f, 0.0F);
                        			this.doBlockTransformations();
                        		}
                        	}else {
